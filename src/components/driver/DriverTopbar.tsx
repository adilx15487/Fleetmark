        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div ref={dropdownRef} className="relative">
            ...
            >
              ...
              />
              <span className="hidden sm:block text-sm font-medium text-slate-700">{user?.name.split(' ')[0] || 'Driver'}</span>
            ...
            {profileOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-white border border-slate-200 rounded-xl shadow-xl overflow-hidden">
                <div className="px-4 py-3 border-b border-slate-100">
                  <p className="text-sm font-semibold text-primary-900">{user?.name || 'Driver'}</p>
