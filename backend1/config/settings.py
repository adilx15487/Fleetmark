...
SECRET_KEY = 'django-insecure-p+)ni5enr1g(kdw-uu9v$q^=1im#^s2gb*))ycobate@1@3(y2'
...
import os
OAUTH_42_CLIENT_ID = os.environ.get(
    'OAUTH_42_CLIENT_ID',
    'u-s4t2ud-05bd2150f84dbad32549e5eac02bc079f38e006a19b3789b640228ac2694d5a0',
)
OAUTH_42_CLIENT_SECRET = os.environ.get(
    'OAUTH_42_CLIENT_SECRET',
    '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',
)
